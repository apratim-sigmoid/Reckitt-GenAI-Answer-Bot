...
st.set_page_config(
    page_title="Reckitt GenAI Answer Bot",
    page_icon="📊",
    layout="wide",
    initial_sidebar_state="expanded"
)

logo = Image.open("images/Reckitt_logo.png")
...
def get_prompt_file(data_source):
    ...
    prompt_mapping = {
        'hospital_contracts.csv': 'prompt/Prompt1.txt',
        'sales_data.csv': 'prompt/Prompt2.txt'
    }
...
def get_sample_queries(data_source):
    ...
    queries = {
        'hospital_contracts.csv': [
            "What are the monthly/quarterly rolling hospital contracts won for MJN?",
            "What are the monthly/quarterly rolling births won for MJN?",
            "Which regions/states have contributed to most wins/losses in hospital contracts?",
            "Which hospital contracts are coming up for renewals?",
            "State-wise hospital birth share for MJN",
            "Which is the biggest hospital that MJN has lost in terms of number of births?",
            "In which state does MJN have the highest number of opportunity cities for winning contracts?"
        ],
        'sales_data.csv': [
            "What is the trend in monthly sales across top brands?",
            "Trend chart for POS sales versus net births won",
            "Compare overall sales performance across states",
            "Compare POS sales performance of various retailers",
            "Retailers showing a negative YOY growth for POS sales in 2024?",
            "Retailers with best YOY growth for POS Sales in 2024"
        ]
    }
...
def main():
    ...
    data_files = {
        'hospital_contracts.csv': 'data/hospital_contracts.csv',  # Replace with your actual filenames
        'sales_data.csv': 'data/sales_data.csv'  # Replace with your actual filenames
    }
